...
//    void offlineECInst(string filename, SSEntry* ssentry, unsigned int ip);
    ...
    void recoveryOffline(string filename); //Conventional(Naive) implementation
    void recoveryPropOnline(string filename); //Proposed(LBFS+ECDAG desgin) implemenation
    void recoveryPivotOnline(string filename);
};
